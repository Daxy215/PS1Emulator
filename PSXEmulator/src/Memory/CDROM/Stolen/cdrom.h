...
FUNCTIONS_EXPORT_API uint8_t cdrom_get_stat(psx_cdrom_t* cdrom);
FUNCTIONS_EXPORT_API void cdrom_error(psx_cdrom_t* cdrom, uint8_t stat, uint8_t err);
FUNCTIONS_EXPORT_API int cdrom_get_seek_delay(psx_cdrom_t* cdrom, int ts);
FUNCTIONS_EXPORT_API int cdrom_get_pause_delay(psx_cdrom_t* cdrom);
FUNCTIONS_EXPORT_API int cdrom_get_read_delay(psx_cdrom_t* cdrom);
FUNCTIONS_EXPORT_API void cdrom_set_int(psx_cdrom_t* cdrom, int n);
FUNCTIONS_EXPORT_API void cdrom_process_setloc(psx_cdrom_t* cdrom);

FUNCTIONS_EXPORT_API psx_cdrom_t* psx_cdrom_create(void);
FUNCTIONS_EXPORT_API void psx_cdrom_init(psx_cdrom_t* cdrom, void (*send_irq)(void*), void* udata);
FUNCTIONS_EXPORT_API void psx_cdrom_reset(psx_cdrom_t* cdrom);
FUNCTIONS_EXPORT_API void psx_cdrom_set_version(psx_cdrom_t* cdrom, int version);
FUNCTIONS_EXPORT_API void psx_cdrom_set_region(psx_cdrom_t* cdrom, int region);
FUNCTIONS_EXPORT_API int psx_cdrom_open(psx_cdrom_t* cdrom, const char* path);
FUNCTIONS_EXPORT_API void psx_cdrom_close(psx_cdrom_t* cdrom);
FUNCTIONS_EXPORT_API uint32_t psx_cdrom_read32(psx_cdrom_t* cdrom, uint32_t addr);
FUNCTIONS_EXPORT_API uint32_t psx_cdrom_read16(psx_cdrom_t* cdrom, uint32_t addr);
FUNCTIONS_EXPORT_API uint32_t psx_cdrom_read8(psx_cdrom_t* cdrom, uint32_t addr);
FUNCTIONS_EXPORT_API void psx_cdrom_write32(psx_cdrom_t* cdrom, uint32_t addr, uint32_t value);
FUNCTIONS_EXPORT_API void psx_cdrom_write16(psx_cdrom_t* cdrom, uint32_t addr, uint32_t value);
FUNCTIONS_EXPORT_API void psx_cdrom_write8(psx_cdrom_t* cdrom, uint32_t addr, uint32_t value);
FUNCTIONS_EXPORT_API void psx_cdrom_update(psx_cdrom_t* cdrom, int cycles);
FUNCTIONS_EXPORT_API void psx_cdrom_get_audio_samples(psx_cdrom_t* cdrom, void* buf, size_t size);
FUNCTIONS_EXPORT_API void psx_cdrom_destroy(psx_cdrom_t* cdrom);
